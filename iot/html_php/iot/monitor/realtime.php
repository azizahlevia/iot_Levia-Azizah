            ...
            window.onload = function () {
                ...
                var updateChart = function (count) {
                    // data json diambil pada alamat /getdata
                     $.getJSON("http://localhost/iot/html_php/iot/monitor/getdata.php", function (data) {
		// $.getJSON("https://api.coindesk.com/v1/bpi/currentprice.json", function (data) {
  		// var suhu = data.bpi.USD.rate_float //mengambil data spesifik rate_float
                var suhu = data.suhu //mengambil data spesifik rate_float
		    if(suhu<29) { 
            document.getElementById("indikator").textContent="Suhu : "+suhu.toString()+" NORMAL : Aman "; 
            ...
            if(suhu>=30 && suhu<31) {  
                document.getElementById("indikator").textContent="Suhu : "+suhu.toString()+" PANAS : ** "; beep();  
			}
	   	   if(suhu>=31) { 
            document.getElementById("indikator").textContent="Suhu : "+suhu.toString()+" SANGAT PANAS : *** "; beep(); beep(); beep();
            }
